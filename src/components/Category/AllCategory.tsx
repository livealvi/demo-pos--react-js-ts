...
import { schemaCategory, schemaUser } from "../../utils/yupSchema";
...
const AllCategory = () => {
  ...
  const handelGetCategory = async (id: number) => {
    navigate(`/category/by/item/${id}/view/all`);
  };
  ...
  const handleDelete = async (id: number) => {
    toast
      .promise(
        ...
        {
          loading: "Loading",
          success: "Category User successfully!",
  ...
  const handleFormSubmit = async (e: any) => {
    ...
    toast
      .promise(
        service.put(`cate/update/${editCategories.id}`, editCategories, {
          headers: { Authorization: "Bearer " + getToken()?.toString() || "" },
        }),
        {
          loading: "Loading",
      ...
      {modal && (
        <div className="modal h-full w-full fixed bg-gray-400 bg-opacity-50 flex justify-center items-center z-10 ">
          <div className="overlay ">
            <div className="modal-content h-full w-full bg-white  rounded-md shadow-lg">
              <div className="modal_head flex items-center justify-between px-10 py-5 border-b-2 border-b-gray-200 hover">
                <span className="text-[20px] text-gray-500">Edit Category</span>
                <VscChromeClose
                  onClick={toggleModal}
                  className="close_modal text-[20px] text-black hover:cursor-pointer"
                />
                    ...
                    <div className="flex justify-around items-center">
                      <div className="w-[70%]">
                        <input
                          type="hidden"
                          id="id"
                          defaultValue={editCategories?.id}
                          className=""
                        />
                          ...
                          <div className="name flex justify-center items-center">
                            ...
                            <div className="w-full">
                              <input
                                ...
                                id="name"
                                {...register("name")}
                                defaultValue={editCategories?.name}
              ...
              <div className="table_box overflow-y-scroll overflow-x-scroll scroll-smooth h-[75vh]">
                {categories?.length === 0 ? (
                  <div className="h-[60vh] flex justify-center items-center text-gray-400">
                    <span className="mr-5">
                      <BiCategoryAlt className="text-[40px]" />
                    </span>
